    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center pt-16 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center relative z-10">
        <div className="space-y-8 animate-fadeIn">
          ...
          <div className="flex flex-col sm:flex-row flex-wrap gap-4 items-center sm:items-stretch justify-center sm:justify-start">
            <a 
              href="#projects" 
              className="px-8 py-4 bg-teal-600 hover:bg-teal-700 text-white rounded-xl font-bold shadow-lg shadow-teal-500/25 transition-all hover:scale-105 w-full sm:w-auto text-center"
            >
              View My Work
            </a>
            <a 
              ...
              className="px-8 py-4 text-teal-600 dark:text-teal-400 font-bold hover:underline rounded-xl text-center bg-transparent w-full sm:w-auto"
            >
              Contact Me
            </a>
          </div>
